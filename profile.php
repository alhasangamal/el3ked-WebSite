...
<html lang="en-US">
  <head>
    ...
    <title><?php echo 'Profile' .' ' . htmlspecialchars($_SESSION["username"]); ?></title>
    ...
    <header>
      <div class="profile-page sidebar-collapse">
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
          <div class="container">
            <div class="navbar-translate"><a class="navbar-brand" href="#" rel="tooltip"><?php echo strtoupper(htmlspecialchars($_SESSION["username"])) . ' Profile'; ?></a>
    ...
    <div class="page-header page-header-small" filter-color="green">
      ...
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="<?php echo 'images/' . htmlspecialchars($_SESSION["image"]); ?>" alt="Image"/></a></div>
          <div class="h2 title"><?php echo strtoupper(htmlspecialchars($_SESSION["username"])) ?></div>
          <p class="category text-white">Web Developer, Graphic Designer,  Photographer</p><a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Hire Me</a><a class="btn btn-primary" href="images/Alhasan_CV.pdf" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Download CV</a>
        </div>
      </div>
      <div class="section">
        <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <p>Hello! I am <?php echo strtoupper(htmlspecialchars($_SESSION["username"]))?>. Web Developer, Graphic Designer and Photographer.</p>
  ...
  <div class="cc-contact-information" style="background-image: url('images/staticmap.png')">
    ...
    <footer class="footer">
      ...
      <div class="text-center text-muted">
        <p>&copy;<?php date("Y") ?> El3ked Website. All rights reserved.<br>Design - <a class="credit" href="#" target="_blank">Alhasan Gamal</a></p>
      </div>
    </footer>
